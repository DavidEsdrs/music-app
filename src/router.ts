...
import { buildDonwloadSong } from "./services/songs/DownloadSong/buildDownloadSong";
import { buildGetSongsFromPlaylist } from "./services/songs/GetSongsFromPlaylist/buildGetSongsFromPlaylist";
...
router.get("/playlist/:id/song", ensureAuthUser, (req, res) => buildGetSongsFromPlaylist().handle(req, res));
